...
const links = [
	...
	{ label: 'Catalogue', href: '/recipes' },
	{ label: 'Orders', href: '/story' },
	{ label: 'Account', href: '/recipes' },
]
...
const Appbar = () => {
	...
	return (
		<div className='fixed top-0 left-1/2 z-20 max-w-[440px] bg-zinc-900 pt-safe transform -translate-x-1/2'>
			<header className='border-b bg-zinc-100 px-safe dark:border-zinc-800 dark:bg-zinc-900'>
				<div className='mx-auto flex h-20 max-w-screen-md items-center justify-between px-6'>
					<Link href='/'>
						<h1 className='font-medium'>Kim Loong Co.</h1>
					</Link>
